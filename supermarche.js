exports.main = function(svg, param) {
	...
	var vignettesProduitsLaitiers = [
        new VignetteRayon("img/produits/Fruits/Bananes.jpg","Bananes",1.1,"/kilo","Produits laitiers"),
    ];
    ...
    var vignettesElectromenager = [
        new VignetteRayon("img/produits/Fruits/Bananes.jpg","Bananes",1.1,"/kilo","Electromenager"),
    ];
    ...
    var vignettesHighTech = [
        new VignetteRayon("img/produits/Fruits/Bananes.jpg","Bananes",1.1,"","HighTech"),
    ];

    var vignettesBoissons = [
        new VignetteRayon("img/produits/Fruits/Bananes.jpg","Bananes",1.1,"","Boissons"),
    ];

    var vignettesSoins = [
        new VignetteRayon("img/produits/Fruits/Bananes.jpg","Bananes",1.1,"","Soins du corps"),
    ];

    var vignettesMode = [
        new VignetteRayon("img/produits/Fruits/Bananes.jpg","Bananes",1.1,"","Mode"),
    ];

    var vignettesMobilier = [
        new VignetteRayon("img/produits/Fruits/Bananes.jpg","Bananes",1.1,"","Mobilier"),
    ];
