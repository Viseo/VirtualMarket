...
ENCOG.GUI.CellGrid.create = function (id, gridWidth, gridHeight, canvasWidth, canvasHeight) {
    ...
    result.canvasDiv.innerHTML = '<canvas width="'
        + canvasWidth*1.25 + '" height="' + canvasHeight*1.25 + '">Browser not supported.</canvas>';
...
ENCOG.GUI.Drawing.create = function (element,x,y,name) {
    'use strict';
    let result = new ENCOG.GUI.Drawing();
    // alert(element.width+" encog");
    result.y=y;
    // alert(y+" , "+name);
    result.x=x;
...
ENCOG.GUI.Drawing.delete = function (element) {
    'use strict';
    let result = new ENCOG.GUI.Drawing();
    result.canvasDiv = element.component;
    result.canvasDiv.innerHTML = '';
};
...
ENCOG.GUI.Drawing.prototype =
{
    ...
    ev_canvas:function (ev) {
       ...
       /* if (ev.layerX || ev.layerX == 0) {
        ...
        // ev._x = (ev.pageX-this.x)*1.25;
        // ev._y = ev.pageY-(this.y/2)*1.25;
        ev._x = ev.pageX*1.25;
        ev._y = ev.pageY*1.25;
        this.started=true;

        // ev._x=ev.layerX*1.25;
        // ev._y=ev.layerY;
...
// This is called when you release the mouse button.
            ...
            if (this.started) {
                ...
                this.drawingContext.stroke();
                this.started = false;
                ENCOG.GUI.Drawing.delete(this.element);
            }
        }
...
// Downsample the drawing area.
    ...
    // alert(this.canvas.height)
        ...
        // this.drawingContext.strokeRect(left,top,right-left,bottom-top);
